...
本章介绍了系统所采用的分布式架构模式(前后端分离、RESTful API、SPA)及核心技术栈(React 18、Node.js+Express、MongoDB、JWT、Zustand),阐述了各技术的特点与本系统中的应用方式;概述了大语言模型原理、多模态视觉模型能力、Prompt工程技术及通义千问模型的选型考量,为后续章节的需求分析、系统设计和算法优化奠定了技术基础。
